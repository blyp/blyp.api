    ...
    <tr>
        <td>
            <table width="560" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td height="70" valign="middle"><h1 style="font-family:Arial,sans-serif;color:#152e6d;font-size:25px;font-weight:bold;"><font face="Arial,sans-serif" color>Contato:</font></h1></td>
                </tr>
                <tr>
                    <td>
                        <p>
                            Assunto: <?php echo $input["subject"]; ?><br>
                            Mensagem: <?php echo $input["message"]; ?><br>
                            Nome do Remetente: <?php echo $input["name"]; ?><br>
                            E-Mail do Remetente: <?php echo $input["email"]; ?>
                        </p>

                        <p>
                            E-mail enviado através do formulário de contato, às <?php echo date("d/m/Y H:i"); ?>.<br><br>
                        </p>
                    </td>
                </tr>
