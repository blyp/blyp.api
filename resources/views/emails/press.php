    ...
    <tr>
        <td>
            <table width="560" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td height="70" valign="middle"><h1 style="font-family:Arial,sans-serif;color:#152e6d;font-size:25px;font-weight:bold;"><font face="Arial,sans-serif" color>Imprensa:</font></h1></td>
                </tr>
                <tr>
                    <td>
                        <p>
                        ...
                        <p>
                            E-mail enviado através do formulário de imprensa, às <?php echo date('d/m/Y H:i'); ?>.<br><br>
                        </p>
                    </td>
                </tr>
