    ...
    <tr>
        <td>
            <table width="560" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td height="70" valign="middle"><h1 style="font-family:Arial,sans-serif;color:#152e6d;font-size:25px;font-weight:bold;"><font face="Arial,sans-serif" color>Nova senha:</font></h1></td>
                </tr>
                <tr>
                    <td>
                        <p>Você solicitou uma nova senha de acesso à nossa plataforma, como medida de segurança, uma nova senha foi gerada.</p>

                        <p>
                            Sua nova senha é:<br>
                            <b style="color:#152e6d;font-size:18px;"><?php echo $input['password']; ?></b>
                        </p>

                        <p>
                            Seus dados de acesso são:<br>
                            E-mail: <?php echo $input['email']; ?><br>
                            Senha: <?php echo $input['password']; ?><br>
                        </p>

                        <p>
                            Qualquer dúvida, entre em contato conosco: we@wearesports.com.br
                        </p>
                    </td>
                </tr>
