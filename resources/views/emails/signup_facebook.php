    ...
    <tr>
        <td>
            <table width="560" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td height="70" valign="middle"><h1 style="font-family:Arial,sans-serif;color:#152e6d;font-size:25px;font-weight:bold;"><font face="Arial,sans-serif" color>Bem-vindo!</font></h1></td>
                </tr>
                <tr>
                    <td>
                        <p>Seja bem-vindo à We Are Esports! Monte seu time, escolha um game e participe de torneios com premiações incríveis.</p>

                        <p>
                            Você se cadastrou com o Facebook, seu perfil de cadastro é:<br>
                            https://www.facebook.com/<?php echo $input['fid']; ?><br><br>
                            Lembre-se de fazer o login através da sua conta no Facebook.<br>
                        </p>

                        <p>
                            Have Fun! Qualquer dúvida, entre em contato conosco: we@wearesports.com.br
                        </p>
                    </td>
                </tr>
